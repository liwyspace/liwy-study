 ...
 * generated in the com.liwy.project.ws.cxf.cxfserver package. 
...
public class ObjectFactory {
    ...
    private final static QName _Map2List_QNAME = new QName("http://cxf.ws.project.liwy.com/", "map2List");
    private final static QName _Map2ListResponse_QNAME = new QName("http://cxf.ws.project.liwy.com/", "map2ListResponse");
    private final static QName _SayHello_QNAME = new QName("http://cxf.ws.project.liwy.com/", "sayHello");
    private final static QName _SayHelloResponse_QNAME = new QName("http://cxf.ws.project.liwy.com/", "sayHelloResponse");
    private final static QName _UpStudent_QNAME = new QName("http://cxf.ws.project.liwy.com/", "upStudent");
    private final static QName _UpStudentResponse_QNAME = new QName("http://cxf.ws.project.liwy.com/", "upStudentResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.liwy.project.ws.cxf.cxfserver
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.ws.project.liwy.com/", name = "map2List")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.ws.project.liwy.com/", name = "map2ListResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.ws.project.liwy.com/", name = "sayHello")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.ws.project.liwy.com/", name = "sayHelloResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.ws.project.liwy.com/", name = "upStudent")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.ws.project.liwy.com/", name = "upStudentResponse")
