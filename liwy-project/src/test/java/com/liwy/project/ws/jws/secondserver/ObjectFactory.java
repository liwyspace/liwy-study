 ...
 * generated in the com.liwy.project.ws.jws.secondserver package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHello_QNAME = new QName("http://second.jws.ws.project.liwy.com/", "sayHello");
    private final static QName _UpStudent_QNAME = new QName("http://second.jws.ws.project.liwy.com/", "upStudent");
    private final static QName _Map2List_QNAME = new QName("http://second.jws.ws.project.liwy.com/", "map2List");
    private final static QName _SayHelloResponse_QNAME = new QName("http://second.jws.ws.project.liwy.com/", "sayHelloResponse");
    private final static QName _UpStudentResponse_QNAME = new QName("http://second.jws.ws.project.liwy.com/", "upStudentResponse");
    private final static QName _Map2ListResponse_QNAME = new QName("http://second.jws.ws.project.liwy.com/", "map2ListResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.liwy.project.ws.jws.secondserver
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://second.jws.ws.project.liwy.com/", name = "sayHello")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://second.jws.ws.project.liwy.com/", name = "upStudent")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://second.jws.ws.project.liwy.com/", name = "map2List")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://second.jws.ws.project.liwy.com/", name = "sayHelloResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://second.jws.ws.project.liwy.com/", name = "upStudentResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://second.jws.ws.project.liwy.com/", name = "map2ListResponse")
