 ...
 * 
 */
@WebServiceClient(name = "FirstServiceService", targetNamespace = "http://jws.ws.project.liwy.com/", wsdlLocation = "http://localhost:8080/liwy-project/service/firstService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName FIRSTSERVICESERVICE_QNAME = new QName("http://jws.ws.project.liwy.com/", "FirstServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/liwy-project/service/firstService?wsdl");
    ...
    public FirstService getFirstServicePort() {
        return super.getPort(new QName("http://jws.ws.project.liwy.com/", "FirstServicePort"), FirstService.class);
    }
    ...
    public FirstService getFirstServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jws.ws.project.liwy.com/", "FirstServicePort"), FirstService.class, features);
    }
