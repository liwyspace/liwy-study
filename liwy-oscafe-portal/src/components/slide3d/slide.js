...
let Slide3d = function(options) {
    let htmlStr = '';
    for(let i=0; i<options.length; i++) {
        let pic = options[i];
        htmlStr += '<li class="no'+(i+1)+'"><div class="zhezhao"><a href="course/7.html" target="_blank">&nbsp;</a></div><a href="course/7.html" target="_blank"><img src="'+pic.pic+'" /></a></li>';
    }
    $(".scroll .images ul").html(htmlStr);
...
let shijian = 500;
const jiangeshijian = 3000;
let nowimg = 2;
let lock = false;
let mytimer = 0;

const s0 = {"width":248 ,"height":131 , "top":100 , "left": 0 ,"opacity":0};
const s1 = {"width":725, "height":321,  "top":50, 	"left": 0,"opacity":1};
const s2 = {"width":874, "height":382,  "top":20,	    "left": 123,"opacity":1};
const s3 = {"width":725, "height":321,  "top":50, 	"left": 415,"opacity":1};
const s4 = {"width":248 ,"height":131 , "top":100 , 	"left": 600,"opacity":0};
